...
package thanatos.android.camera.view;
...
import thanatos.android.camera.core.FlashMode;
import thanatos.android.camera.core.FocusMeteringAction;
import thanatos.android.camera.core.ImageCapture;
import thanatos.android.camera.core.ImageProxy;
import thanatos.android.camera.core.MeteringPoint;
import thanatos.android.camera.core.VideoCapture;

/**
 * A {@link View} that displays a preview of the camera with methods {@link
 * #takePicture(ImageCapture.OnImageCapturedListener)}, {@link #takePicture(File, ImageCapture.OnImageSavedListener)}, {@link
 * #startRecording(File, VideoCapture.OnVideoSavedListener)} and {@link #stopRecording()}.
 *
...
public final class CameraView extends ViewGroup {
     ...
     * Lifecycle.State#DESTROYED} state. Call this method only once camera
     * permissions have been obtained.
     *
     * <p>Once the provided lifecycle has transitioned to a {@link
     * Lifecycle.State#DESTROYED} state, CameraView must be bound to a new
    ...
    /**
     * Sets the maximum video duration before {@link VideoCapture.OnVideoSavedListener#onVideoSaved(File)} is
    ...
    /**
     * Sets the maximum video size in bytes before {@link VideoCapture.OnVideoSavedListener#onVideoSaved(File)}
    ...
    /**
     * Takes a picture, and calls {@link ImageCapture.OnImageCapturedListener#onCaptureSuccess(ImageProxy, int)}
     * once when done.
     *
    ...
    /**
     * Takes a picture and calls {@link ImageCapture.OnImageSavedListener#onImageSaved(File)} when done.
     *
     ...
     * device, as determined by {@link #hasCameraWithLensFacing(CameraX.LensFacing)}, the first supported
    ...
    /** Returns the currently selected {@link CameraX.LensFacing}. */
    @Nullable
