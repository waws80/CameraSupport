...
import thanatos.android.camera.core.CameraOrientationUtil;
...
final class CameraXModule {
    ...
    public void takePicture(File saveLocation, ImageCapture.OnImageSavedListener listener) {
        if (mImageCapture == null) {
            return;
        }
    ...
    public void startRecording(File file, final VideoCapture.OnVideoSavedListener listener) {
