...
import thanatos.android.camera.core.CameraCaptureCallbacks;
...
final class CaptureCallbackConverter {
    ...
    static void toCaptureCallback(
        ...
        if (cameraCaptureCallback instanceof CameraCaptureCallbacks.ComboCameraCaptureCallback) {
            ...
            CameraCaptureCallbacks.ComboCameraCaptureCallback comboCallback =
                    (CameraCaptureCallbacks.ComboCameraCaptureCallback) cameraCaptureCallback;
