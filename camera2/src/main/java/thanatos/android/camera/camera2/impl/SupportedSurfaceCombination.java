...
import thanatos.android.camera.core.SurfaceConfig.ConfigType;

import thanatos.android.camera.core.SurfaceConfig.ConfigSize;
...
import thanatos.android.camera.core.CameraDeviceConfig;
import thanatos.android.camera.core.CameraInfoUnavailableException;
import thanatos.android.camera.core.CameraX;
import thanatos.android.camera.core.ImageFormatConstants;
import thanatos.android.camera.core.ImageOutputConfig;
import thanatos.android.camera.core.SurfaceCombination;
import thanatos.android.camera.core.SurfaceConfig;
import thanatos.android.camera.core.SurfaceSizeDefinition;
...
final class SupportedSurfaceCombination {
    ...
    List<SurfaceCombination> getLegacySupportedCombinationList() {
        ...
        surfaceCombination1.addSurfaceConfig(
                SurfaceConfig.create(SurfaceConfig.ConfigType.PRIV, SurfaceConfig.ConfigSize.MAXIMUM));
        ...
        surfaceCombination4.addSurfaceConfig(
                SurfaceConfig.create(ConfigType.PRIV, SurfaceConfig.ConfigSize.PREVIEW));
        surfaceCombination4.addSurfaceConfig(
